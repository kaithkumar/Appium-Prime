...
public class BaseClass {
	...
	/**
	 * @author kaith
	 * @param type -> mentions platform type to be used, user defined Enum
	 * @param lauchType ->mentions start type of the application, to be invoked or installed, user defined Enum
	 */
	...
	/**
	 * @author kaith
	 * @returns appium driver local service object, used to start and stop the appium server
	 */
    ...
    /**
	 * @author kaith
	 * @returns appium driver local service object is used to start the appium server
	 */
    ...
    /**
     * @author kaith
     * @param key -> case sensitive key has to be provided 
     * @return value of the key provided as input
     */
